class Gw < Formula
  ...
  url "https://github.com/v-gutierrez/gw/archive/refs/tags/v0.8.2.tar.gz"
  sha256 "cc471cf7363a2881c3f7e54ea678045d0afeeaae7a8f30335fc5cf9b41ca0f79"
  license "MIT"
  ...
  test do
    assert_match "0.8.2", shell_output("#{bin}/gw --version")
  end
end
